...
// 6 = LATCH, 7 = OE, side set 8 = CLK
// Data pins are 0..5: R0, G0, B0, R1, G1, B1
// Row sel pins are : 16..20 : A ..E

#define DISPLAY_DATAPINS_BASE 0
#define DISPLAY_DATAPINS_COUNT 6

// A, B, C, D. E pins for row selection, consecutive
#define DISPLAY_ROWSEL_BASE 16
#define DISPLAY_ROWSEL_COUNT 5

// Pins layout
#ifdef PIN_LAYOUT_B
#define DISPLAY_LATCHPIN 8
#define DISPLAY_OENPIN 6
#define DISPLAY_CLKPIN 7
#else
#define DISPLAY_LATCHPIN 6
#define DISPLAY_OENPIN 7
#define DISPLAY_CLKPIN 8
#endif
...
#ifdef PIN_LAYOUT_B
#define PIO_DATA_SET_BASE       DISPLAY_OENPIN
#define PIO_DATA_SET_CNT        3   // OE (6), CLK (7), LATCH (8)
#else
#define PIO_DATA_SET_BASE       DISPLAY_LATCHPIN
#ifdef HUB75_BCM
#define PIO_DATA_SET_CNT        2   // LATCH and OE in BCM version
...
#ifdef PIN_LAYOUT_B
#define PIO_CTRL_SET_BASE       DISPLAY_OENPIN
#define PIO_CTRL_SET_CNT        3
#else
#define PIO_CTRL_SET_BASE       DISPLAY_LATCHPIN
#define PIO_CTRL_SET_CNT        2
#endif
...
/*! \brief Stop and release all hardware resources used by the HUB75 driver
 *  \ingroup HUB75
 */
void hub75_stop();
